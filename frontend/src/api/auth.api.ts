...
import type { ApiResponse, LoginResponse, RegisterResponse, User, RegisterInput, LoginInput } from '@/types';

export const authApi = {
  register: async (data: RegisterInput): Promise<ApiResponse<RegisterResponse>> => {
